---
navigation_title: v1 Specification
---
...
| Field | Type | Description |
|---|---|---|
| `role` | string | `"flag"`, `"positional"`, `"confirmationSkip"`, or `"dryRun"` — see [6.1 Roles](#6.1-roles) |
...
| `deprecated` | boolean \| [Deprecation Object](#11.1-deprecation-object) | — | Marks the parameter as deprecated |
| `validations` | [Constraint Object](#6.2-constraints)[] | — | Validation rules applied to the parameter's value |
...
| `deprecated` | boolean \| [Deprecation Object](#11.1-deprecation-object) | — | Marks the command as deprecated |
...
| Field | Type | Description |
|---|---|---|
| `variables` | [Env Var Object](#9.1-env-var-object)[] | Environment variables |
| `configFiles` | [Config File Object](#9.2-config-file-object)[] | Configuration files |
